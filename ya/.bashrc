...
if [ "$color_prompt" = yes ]; then
    PS1='\n\[\e[1;37m\][$(date +"%Y-%m-%d %H:%M:%S")] ${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]: \[\033[01;34m\]\w\[\033[00m\] \[$txtcyn\]<$arc_branch>\[$txtred\]$arc_dirty\[$txtrst\]\n\[\e[1;37m\]$\[\e[0;37m\] '
else
...
# ya related
export PATH=$PATH:$HOME/arc/arcadia/
#export PATH=$PATH:$HOME/mini-arcadia/devtools/ya
alias vim='ya vim'
#alias vi='ya vim'
#alias yasvn='ya tool svn'
# arc autocomplete
